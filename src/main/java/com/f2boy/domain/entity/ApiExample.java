...
public class ApiExample {
    ...
    protected abstract static class GeneratedCriteria {
        protected List<Criterion> paramsCriteria;
        ...
        protected GeneratedCriteria() {
            ...
            paramsCriteria = new ArrayList<Criterion>();
        }

        public List<Criterion> getParamsCriteria() {
            return paramsCriteria;
        }

        protected void addParamsCriterion(String condition, Object value, String property) {
            if (value == null) {
                throw new RuntimeException("Value for " + property + " cannot be null");
            }
            paramsCriteria.add(new Criterion(condition, value, "com.f2boy.typehandler.ApiParamsJsonTypeHandler"));
            allCriteria = null;
        }

        protected void addParamsCriterion(String condition, ApiParams value1, ApiParams value2, String property) {
            if (value1 == null || value2 == null) {
                throw new RuntimeException("Between values for " + property + " cannot be null");
            }
            paramsCriteria.add(new Criterion(condition, value1, value2, "com.f2boy.typehandler.ApiParamsJsonTypeHandler"));
            allCriteria = null;
        }

        public boolean isValid() {
            return criteria.size() > 0
                || paramsCriteria.size() > 0;
        }
        ...
        public List<Criterion> getAllCriteria() {
            if (allCriteria == null) {
                ...
                allCriteria.addAll(paramsCriteria);
            }
            return allCriteria;
        }
        ...
        public Criteria andParamsEqualTo(ApiParams value) {
            addParamsCriterion("params =", value, "params");
            return (Criteria) this;
        }

        public Criteria andParamsNotEqualTo(ApiParams value) {
            addParamsCriterion("params <>", value, "params");
            return (Criteria) this;
        }

        public Criteria andParamsGreaterThan(ApiParams value) {
            addParamsCriterion("params >", value, "params");
            return (Criteria) this;
        }

        public Criteria andParamsGreaterThanOrEqualTo(ApiParams value) {
            addParamsCriterion("params >=", value, "params");
            return (Criteria) this;
        }

        public Criteria andParamsLessThan(ApiParams value) {
            addParamsCriterion("params <", value, "params");
            return (Criteria) this;
        }

        public Criteria andParamsLessThanOrEqualTo(ApiParams value) {
            addParamsCriterion("params <=", value, "params");
            return (Criteria) this;
        }

        public Criteria andParamsLike(ApiParams value) {
            addParamsCriterion("params like", value, "params");
            return (Criteria) this;
        }

        public Criteria andParamsNotLike(ApiParams value) {
            addParamsCriterion("params not like", value, "params");
            return (Criteria) this;
        }

        public Criteria andParamsIn(List<ApiParams> values) {
            addParamsCriterion("params in", values, "params");
            return (Criteria) this;
        }

        public Criteria andParamsNotIn(List<ApiParams> values) {
            addParamsCriterion("params not in", values, "params");
            return (Criteria) this;
        }

        public Criteria andParamsBetween(ApiParams value1, ApiParams value2) {
            addParamsCriterion("params between", value1, value2, "params");
            return (Criteria) this;
        }
